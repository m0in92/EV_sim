...
class DriveCycle:
    """
    DriveCycle class searches for and stores arrays of time and desired speed informations.
    """
    def __init__(self, drive_cycle_name: str = "udds", folder_dir: str = definations.ROOT_DIR +
                                                                         "/data/drive_cycles/"):
        """
